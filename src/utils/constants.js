...
export const TERMS_DESCRIPTION = "J'ai lu et j'accepte les conditions générales d'utilisation du Coach Climat";
...
export const HERO_DESCRIPTION = 'Réduis tes émissions de CO₂ pour contribuer à la neutralité carbone des Jeux !';
...
export const MAIN_DESC1 = 'Dans la lutte contre le changement climatique, chaque action compte !';
export const MAIN_DESC2 =
	'C’est pourquoi Paris 2024 a créé le Coach Carbone, un  outil dédié, qui te permet de calculer tes émissions de CO₂ annuelles.';
...
export const SECTION2_TITLE = '2/3 Qu’est-ce que l’impact carbone et pourquoi le calculer ?';
...
export const WEBSITE_INFO_MSG = "Plus d'informations ? Consulte notre page dédiée :";
...
/* Action de reduction */
export const SUR_TITLE_ACTION = 'À remplir à la fin du test si c’est la première fois !';
...
export const INTRODUCTION_QUESTION1_INFOS = 'Prends en compte tes jours de télétravail ici. (≈ 218 jours)';
export const INTRODUCTION_QUESTION1_ERROR_MSG = '⚠ Merci de saisir votre réponse';
export const INTRODUCTION_QUESTION2 = 'Ancienneté dans le COJO (en mois)';
export const INTRODUCTION_QUESTION2_ERROR_MSG = '⚠ Merci de saisir votre réponse';
export const INTRODUCTION_QUESTION3 = 'Nombre de jours de télétravail par mois';
export const INTRODUCTION_QUESTION3_ERROR_MSG = '⚠ Merci de saisir votre réponse';
...
// Au bureau
export const TITLE_ORDINATEURS = "Nombre d'ordinateurs portable professionnels mis à votre disposition";
export const TITLE_TELEPHONES = 'Nombre de téléphones portables professionnels mis à votre disposition';
export const TITLE_ECRANS = "Nombre d'écrans additionels mis à votre disposition";

// Empreinte numérique
export const TAILLE_BOITE = 'Taille de ta boîte mail (en Go)';
export const TAILLE_BOITE_INFO = 'Pour trouver cette information, check le « pop-in conseil » plus bas !';
export const TAILLE_BOITE_ERROR_MSG = '⚠ Merci de saisir votre réponse';
export const EMPREINTE_OVERLAY_TITLE = 'Comment connaître la taille de ta boîte mail ?';
export const TAILLE_STOCKAGE = 'Taille de ton stockage en ligne, type SharePoint/OneDrive (en Go)';
...
export const NBR_CONFERENCE = "Nombre d'heures passées en conférence visio par jour (en moyenne)";
export const NBR_STREAMING = "Nombre d'heures de streaming vidéo dans le cadre professionnel par jour (en moyenne)";
...
// Trajets
export const DISTANCE_DOMICILE_TRAVAIL = 'Distance entre ton domicile et ton travail (km)';
export const DISTANCE_DOMICILE_TRAVAIL_ERROR_MSG = '⚠ Merci de saisir votre réponse';
...
export const MOTORISATION_INFOS = 'Pour le métro, tramway, train, RER et TGV, la motorisation est électrique !';
...
export const MAKE_TRANSPORTATION_LABEL = 'Effectuez-vous des déplacements professionels ?';
...
export const NBR_KM_VOITURE = 'Nombre de km en voiture (location, personnelle, ou taxi)';
export const QUESTION2_NBR_TRAJETS_AR = "Nombre d'aller-retours en intercités ou TER (<200 km)";
export const QUESTION3_NBR_TRAJETS_AR = "Nombre d'aller-retours en train TGV (à environ 250 km)";
export const QUESTION4_NBR_TRAJETS_AR =
	"Nombre d'aller-retours en train TGV (à environ 500 km) autres qu'au CIO à Lausanne";
export const QUESTION5_NBR_TRAJETS_AR = "Nombre d'aller-retours en train TGV (à environ 800 km)";
export const QUESTION6_NBR_TRAJETS_AR = "Nombre d'aller-retours en train au CIO à Lausanne";
export const QUESTION7_NBR_TRAJETS_AR = "Nombre d'aller-retours en avion au CIO à Lausanne en Economie";
export const QUESTION8_NBR_VOLS_AR = "Nombre d'aller-retours longs courriers à Tokyo";
export const QUESTION9_NBR_VOLS_AR = "Nombre d'aller-retours courts courriers (<5h)";
export const QUESTION10_NBR_VOLS_AR = "Nombre d'aller-retours longs courriers (>5h et < 10h)";
export const QUESTION11_NBR_VOLS_AR = "Nombre d'aller-retours longs courriers (>10h)";

// Restauration
export const REPAS_QUESTION1 = 'De quoi sont majoritairement composés tes repas au bureau ?';
export const REPAS_QUESTION1_INFO = 'Coche 5 cases pour tes 5 déjeuners au boulot de la semaine !';
...
export const CURSEUR_BOISSONS = 'Combien de boissons chaudes prends-tu par jour ?';
...
export const ALIMENTATION_QUESTION2 = 'De quoi sont composés majoritairement tes dîners en semaine ?';
export const ALIMENTATION_QUESTION3 = 'De quoi sont composés majoritairement tes repas en week-end ?';
export const ALIMENTATION_QUESTION = 'De quoi sont majoritairement composés tes repas ?';
...
export const ALIMENTATION_QUESTION4 = 'De quoi sont composés majoritairement tes repas en vacances ?';
...
export const ALIMENTATION_QUESTION6 = 'Eau en bouteille consommés par semaine (L)';
...
export const ALIMENTATION_QUESTION9 = 'Alcool, hors vin et bière, consommés par semaine (L)';
...
export const TRANSPORTATION_LABEL = 'Effectuez-vous des déplacements personnels en ?';
export const DEPLACEMENTS_QUESTION1 = 'Distance parcourue en voiture par an (véhicule personnel ou de location)';
export const DEPLACEMENTS_QUESTION1_ERROR_MSG = '⚠ Merci de saisir votre réponse';
...
export const DEPLACEMENTS_QUESTION4 = 'Nombre de trajets AR en train TGV par an';
export const DEPLACEMENTS_QUESTION5 = 'Nombre de vols AR courts courriers (<5h)';
export const DEPLACEMENTS_QUESTION6 = 'Nombre de vols AR longs courriers (>5h et <10h)';
export const DEPLACEMENTS_QUESTION7 = 'Nombre de vols AR longs courriers (>10h)';
...
export const HOUSE_QUESTION2 = "Consommation annuelle d'Electricité de votre logement";
...
export const HOUSE_QUESTION3 = 'Consommation annuelle de Gaz naturel de votre logement';
export const HOUSE_QUESTION3_TOOTLTIP =
	'De même : facture ou espace client ! En moyenne 14000kwh/100 m² pour 4 personnes';
export const HOUSE_QUESTION4 = 'Consommation annuelle de Fioul domestique de votre logement';
export const HOUSE_QUESTION4_TOOTLTIP = 'Calculable en effectuant en relevé de ta cuve à fioul. En moyenne 150L/m2/an.';
export const HOUSE_QUESTION5 = 'Consommation annuelle de bois de chauffage pour votre logement';
...
export const HOUSE_QUESTION9_TOOTLTIP = 'Indiquée sur ton bail / acte de vente.';
export const HOUSE_QUESTION10 = 'Classe Energie de ton logement, DPE (si vous le connaissez)';
...
export const HOUSE_QUESTION11 = 'Sinon ton logement a été construit (ou rénové)';
export const HOUSE_ERROR_MSG = '⚠ Merci de saisir votre réponse';
export const OVERLAY_TITLE_HOUSE = 'Comment optimiser ta consommation d’énergie ?';
...
export const NUMERIC_QUESTION2_LABEL = "Nombre d'heures de streaming vidéo, et gaming par jour";
...
export const MATERIELS_QUESTION1_LABEL = 'Nombre de voitures Micro-urbaines, Mini-citadines';
export const MATERIELS_QUESTION2_LABEL = 'Nombre de voitures Polyvalantes, Monospaces Compacts';
export const MATERIELS_QUESTION3_LABEL = 'Nombre de voitures SUV, berlines, monospaces';
...
export const MATERIELS_QUESTION14_LABEL = 'Nombre de vêtements neufs achetés par an (articles)';
export const MATERIELS_QUESTION15_LABEL = 'Nombre de paires de chaussures neuves achetées par an';
