...
export const IDENTIFIER_NOT_VALID = "⚠ Veuillez respecter le format d'émail (exemple@paris2024.org)";
/* Home Page */
...
export const ABOUT_CONTENT1 = "Paris 2024 s’est engagé à réduire de moitié les émissions de CO2 liées à l’organisation des Jeux, du collaborateur, jusqu’au spectateur.";
export const ABOUT_CONTENT2 = "C’est pourquoi le Coach Carbone est là pour vous aider à comprendre et réduire votre impact sur le climat par des actions concrètes.";
export const ABOUT_CONTENT3 = "Les résultats proposés ont fait l'objet d'une modélisation. Ils sont représentatifs d'un ordre de grandeur, mais ils n'ont pas pour but d'être exhaustifs. Une part d'incertitude existe comme dans toute modélisation.";
export const MAIN_DESC1 = "Dans la lutte contre le changement climatique, chaque action compte !";
export const MAIN_DESC2 = "C’est pourquoi Paris 2024 a crée le Coach Carbone, un  outil dédié, qui te permet de calculer tes émissions de CO2 annuelles.";
export const MAIN_DESC3 = "Il distingue les émissions liées à ta vie professionnelle des émissions liées à ta vie personnelle pour te permettre de visualiser l'impact concret de tes actions, et te donner des moyens pour le réduire.";

export const SECTION1_TITLE = "Comment ça marche ?";
export const SECTION1_PARAG1 = "Pendant l’exercice, il vous sera demandé de répondre à des questions concernant vos activités dans la vie professionnelle et personnelle.";
export const SECTION1_PARAG2 = "Une fois vos informations renseignées, votre impact carbone s’affichera, et vous aurez accès au détail de vos émissions ainsi que l'impact des actions que vous aurez considéré.";
export const SECTION1_PARAG3 = "Les résultats proposés ont fait l'objet d'une modélisation. Ils sont représentatifs d'un ordre de grandeur, mais ils n'ont pas pour but d'être exhaustifs. Une part d'incertitude existe comme dans toute modélisation.";
export const SECTION1_PARAG4 = "Comparez l'effet d'une action plutôt qu'une autre, comparez vos résultats avec ceux de vos collègues !";
export const SECTION1_PARAG5 = "Si vous ne pouvez pas répondre à une question, la valeur d'un français moyen sera utilisé pour que vous puissiez continuer l'exercice.";

export const SECTION2_TITLE = "Qu’est-ce que l’impact carbone et pourquoi le calculer ?";
...
/* Menu Page */
export const MENU_DESCRIPTION = "Le coach carbone te propose un parcours en 3 temps, d’une durée approximative de 30min. A vos marques, prêts, calculez !";
