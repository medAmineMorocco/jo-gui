          ...
          .then(() => {
            cy.takeSnapshots("form - alimentation", size).then(() => {
              cy.get(".custom-btn-modal")
                ...
                .then(() =>
                  cy
                    .takeSnapshots("form - alimentation conseils", size)
                    .then(() => {
                      ...
                      cy.get(".ant-switch")
                        ...
                        .then(() =>
                          cy.takeSnapshots(
                            "form - alimentation actions de réduction",
                            size
                          )
                        );
                    })
  ...
  it("should submit form", () => {
    cy.window().then((win) => {
      ...
      cy.get(".footer-navigation-left span")
        .contains("Alimentation")
        .should("exist");
      cy.get(".footer-navigation-right span")
        .contains("Services publics")
        .should("exist");
      cy.get(".footer-buttons-left button").click();
      cy.get("#5f5570e5d882c > .flex-container-button > #result-counter")
        .contains("1")
        .should("exist");
      ...
      cy.get("#5f557459e6c45 > .flex-container-button > #result-counter")
        .contains("3")
        .should("exist");
      cy.get("#5f5574ead218e > .flex-container-button > #result-counter")
        .contains("4")
        .should("exist");
      cy.get("#5f557508ea4c5 > .flex-container-button > #result-counter")
        .contains("2")
        .should("exist");
      cy.get("#5f557531751f2 > .flex-container-button > #result-counter")
        .contains("3")
        .should("exist");
      cy.get("#5f55754725a12 > .flex-container-button > #result-counter")
        .contains("4")
        .should("exist");
    });
  });
